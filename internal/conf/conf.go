...
type RunnerConfig struct {
	...
	SkipTransactionConfirmations bool
}
...
type InstanceConfig struct {
	...
	SkipTransactionConfirmations bool             `json:"skipTransactionConfirmations,omitempty" yaml:"skipTransactionConfirmations,omitempty"`
